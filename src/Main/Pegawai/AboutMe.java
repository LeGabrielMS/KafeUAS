...
public class AboutMe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kafe Barra's Kitchen");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Pemrograman Berorientasi Objek 2");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Gabriel Marcellino Sinurat - 22552011043");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        MainMenu_Pegawai menuIntent = new MainMenu_Pegawai();
        this.dispose();
        menuIntent.setVisible(true);
