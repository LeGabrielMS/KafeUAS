...
import Main.Pegawai.MainMenu_Pegawai;
import Main.User.Register_User;
import Main.User.MainMenu_User;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (txUsername.getText().equals("") && txPassword.getText().equals("")) {
            // Jika username dan password kosong, tampilkan pesan kesalahan
            ...
            try {
                ...
                // Mengeksekusi query untuk mencari user dengan username dan password yang diinput
                ResultSet sql = stm.executeQuery("SELECT * FROM data_user WHERE username='" + txUsername.getText()
                        + "' and password='" + txPassword.getText() + "'");

                if (sql.next()) {
                    // Jika user ditemukan, verifikasi password
                    if (txPassword.getText().equals(sql.getString("password"))) {
                        ...
                        // Memeriksa role user dan membuka form yang sesuai
                        if (role.equals("Pegawai")) {
                            // Jika role adalah "Pegawai", buka form MainMenu_Pegawai
                            MainMenu_Pegawai fm = new MainMenu_Pegawai();
                            fm.setVisible(true);
                        } else if (role.equals("Pelanggan")) {
                            // Jika role adalah "Pelanggan", buka form MainMenu_User
                            MainMenu_User fu = new MainMenu_User();
                            fu.setVisible(true);
                        }
                        ...
                        // Kosongkan field username dan password serta fokuskan ke field username
                        txUsername.setText("");
                        txPassword.setText("");
                    ...
                    // Jika username dan password tidak ditemukan di database, tampilkan pesan kesalahan
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        Register_User registerIntent = new Register_User();
        this.dispose();
        registerIntent.setVisible(true);
